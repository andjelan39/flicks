    ...
    <div class="container p-4">
        <div class="row mt-4">
            <div class="col-lg-4 col-md-12 mb-4 mb-md-0">
                ...
                <p>
                    Flicks is the largest and best-known cinema chain in the UK and Ireland.
                </p>

                <p>
                    We're determined to give every guest a great experience every time they visit, and so continuously
                    strive to innovate and improve our hospitality and services.
                </p>
                ...
                <ul class="fa-ul" style="margin-left: 1.65em;">
                    ...
                    <li class="mb-3">
                        <span class="fa-li"><i class="fas fa-envelope"></i></span><span
                            class="ms-2">flicks@cinema.co.uk</span>
                    </li>
                    <li class="mb-3">
